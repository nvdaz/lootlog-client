...
import xyz.nvda.lootlog.api.AddSlayerMutation;
import xyz.nvda.lootlog.api.AddSlayerMutation.AddSlayer;
import xyz.nvda.lootlog.api.AddSlayerMutation.Data;
import xyz.nvda.lootlog.api.AddSlayerMutation.Variables;
import xyz.nvda.lootlog.api.ItemProvidersQuery;
import xyz.nvda.lootlog.api.NotableSlayersQuery;
import xyz.nvda.lootlog.api.NotableSlayersQuery.CurrentUser;
import xyz.nvda.lootlog.api.NotableSlayersQuery.NotableSlayer;
import xyz.nvda.lootlog.api.type.SlayerRewardInput;
import xyz.nvda.lootlog.api.type.SlayerRewardType;
import xyz.nvda.lootlog.api.type.SlayerType;
import xyz.nvda.lootlog.util.DelayedTask;

public class SlayerHandler
    extends BossHandler<Data, Variables, AddSlayerMutation, SlayerRewardInput, SlayerRewardType> {
  ...
  protected List<ItemProvider> mapProviders(List<ItemProvidersQuery.ItemProvider> itemProviders) {
    return itemProviders.stream()
        .map(ItemProvidersQuery.ItemProvider::asSlayerItemProvider)
